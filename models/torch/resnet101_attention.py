"""
This model's basic architecture has been adapted from https://github.com/Subangkar/Image-Captioning-Attention-PyTorch itself adapted from https://github.com/sgrvinod/a-PyTorch-Tutorial-to-Image-Captioning (https://youtu.be/jcvd5JZkUXY)
...
class DecoderWithAttention(nn.Module):
	...
	def __init__(self, attention_dim, embed_dim, decoder_dim, vocab_size, encoder_dim=2048, dropout=0.5, embedding_matrix=None, train_embd=True):
		"""
		...
		self.embedding = embedding_layer(num_embeddings=vocab_size, embedding_dim=embed_dim, embedding_matrix=embedding_matrix, trainable=train_embd)
...
class Captioner(nn.Module):
	def __init__(self, encoded_image_size, attention_dim, embed_dim, decoder_dim, vocab_size, encoder_dim=2048, dropout=0.5, **kwargs):
		super().__init__()
